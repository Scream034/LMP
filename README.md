...
Главная цель проекта — экстремальная оптимизация ресурсов (CPU/RAM/Сеть). В отличие от официального PWA и Electron-клиентов, LMP потребляет в среднем **235 МБ RAM** (в свернутом виде падает до **180 МБ**).
...
* [x] Управление плейлистами с ютуба и локально
