...
public class DownloadService
{
    ...
    private readonly SemaphoreSlim _downloadSemaphore = new(3); // Максимум 3 параллельных загрузки

    public event Action<string, float>? OnProgress;
    public event Action<string, bool, string?>? OnCompleted; // trackId, success, filePath
