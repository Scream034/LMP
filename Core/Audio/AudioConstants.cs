...
/// Все магические числа в одном месте для удобства настройки и zero duplication.
/// </summary>
public static class AudioConstants
{
    ...
    public const int DownloadTimeoutMs = 15000;
    ...
    public const int CacheAutoSaveIntervalMs = 30000;
    ...
    // HLS SETTINGS — Специфичные для HLS потоков
